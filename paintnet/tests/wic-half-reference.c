/* Public WIC half-float pixel format metadata and bitmap measurements.
...
int main(void)
{
    static const GUID *formats[]={&GUID_WICPixelFormat64bppRGBAHalf,&GUID_WICPixelFormat64bppPRGBAHalf,
            &GUID_WICPixelFormat48bppRGBHalf,&GUID_WICPixelFormat16bppGrayHalf,&GUID_WICPixelFormat128bppPRGBAFloat};
