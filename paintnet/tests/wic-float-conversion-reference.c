/* WIC conversion of straight/premultiplied floating-point RGBA to display pixels.
...
int main(void)
{
    ...
    float pixels[12][8][4];BYTE output[12*(8*16+8)];
    ...
    {
        printf("case %u %u\n",src,dst);
        REQUIRE(IWICImagingFactory_CreateBitmapFromMemory(f,8,12,sources[src],8*16,sizeof(pixels),(BYTE *)pixels,&bitmap));
