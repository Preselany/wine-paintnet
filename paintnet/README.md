...
Convolve Matrix, Contrast, Bitmap Source, Emboss, Opacity, custom source draw shaders, UIAnimation, and shader-requirement
...
normal Wine/DXVK tests. `build-reference.sh` builds standalone Emboss, property, animation, shader-reflection, and custom draw-transform
