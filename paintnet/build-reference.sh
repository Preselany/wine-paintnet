...
for probe in emboss-reference emboss-grid8-reference effect-properties-reference animation-reference shader-reflection-reference draw-transform-reference command-list-reference command-context-reference color-context-reference color-context-icc-reference; do
    probe_source="$probe"
    probe_flags=()
