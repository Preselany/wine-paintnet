...
if [[ $# == 0 ]]; then set -- dlls/d2d1/all dlls/d2d1/tests/all dlls/uianimation/all dlls/uianimation/tests/all dlls/wined3d/all dlls/d3dcompiler_47/tests/all dlls/coremessaging/all dlls/coremessaging/tests/all; fi
