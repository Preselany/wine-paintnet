...
if [[ $# == 0 ]]; then set -- dlls/d2d1/all dlls/d2d1/tests/all dlls/dwrite/all dlls/dwrite/tests/all dlls/windowscodecs/all dlls/windowscodecs/tests/all dlls/uianimation/all dlls/uianimation/tests/all dlls/wined3d/all dlls/d3dcompiler_47/tests/all dlls/coremessaging/all dlls/coremessaging/tests/all dlls/dcomp/all dlls/dcomp/tests/all dlls/user32/all dlls/user32/tests/all dlls/comdlg32/all dlls/comdlg32/tests/all; fi
